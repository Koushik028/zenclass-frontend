                            ...
                            <div className="mx-1 secondaryGreyTextColor">
                                <div className="col-12">
                                    ...
                                    <div className="mx-2 py-1 px-2 ">
                                        <p>Implement the Pokemon API using async/await with fetch.</p>
                                        ...
                                        <ul>
                                            ...
                                            <li>Use fetch() to get the data from Pokemon API</li>
                                        ...
                                        <p>https://pokemon.io/</p>
                                        <p>https://pokemon.io/#responses/</p>
